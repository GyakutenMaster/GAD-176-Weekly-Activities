...
namespace GAD176.WeeklyActivities.WeekTwelve
{
    ...
    public class Tank : MonoBehaviour
    {
        ...
        public int PlayerScore
        {
            ...
            {
                playerScore = value;
                // invoke our player score event and pass in our player number and our current score.
        ...
        private void Dead()
        {
            // so here lets call the objectpooler instance and call spawn from pool, the pass in the explosion prefab, the position of the tank,
            // and use the rotation of the explosion prefab
            ...
            // here lets call the object pooler instnace and call return from pool function, that then passes in the clone we just created after 2 seconds.
            ObjectPooler.Instance.ReturnToPool(clone, 2);
            gameObject.SetActive(false);

            // invoke the player has died event and pass in ourselves as the gameobject
