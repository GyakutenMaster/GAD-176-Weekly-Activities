...
namespace GAD176.WeeklyActivities.WeekTwelve.Completed
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "Week 12", menuName = "Completed/Week 12/Gun", order = 0)]
    public class SingleFireGun : ScriptableObject
    {
        ...
        private void FireWeapon(bool ButtonReleased = false)
        {
            ...
            // here lets call the Object pooler instance and call the spawn from pool function.
            // then lets pass in the tank shell prefab, the firepoint transform position, and the firepoint's rotation.
            GameObject clone = ObjectPooler.Instance.SpawnFromPool(tankShellPrefab, firePointTransform.position, firePointTransform.rotation);
            ...
            // here lets call the return to pool function and pass in the clone after 5 seconds.
            // this is just in case the event that the bullet falls through the world forever.
            ObjectPooler.Instance.ReturnToPool(clone, 5);
