...
namespace GAD176.WeeklyActivities.WeekNine
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "Week 9", menuName = "Week 9/Motor", order = 0)]
    public class Motor : ScriptableObject
    {
        ...
        [SerializeField] protected ParticleEffects motorMoveEffects; // Particle effects for tank movement.
        ...
        void SetUpVisuals()
        {
            if (motorMoveEffects)
            {
                ...
                motorMoveEffects = ScriptableObject.Instantiate(motorMoveEffects);
                ...
                motorMoveEffects.SetUpEffects(objectReference, true); // Set up tank effects.
            }
        }
