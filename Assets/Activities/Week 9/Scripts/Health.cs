...
namespace GAD176.WeeklyActivities.WeekNine
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "Week 9", menuName = "Week 9/Health", order = 0)]
    public class Health : ScriptableObject
    {
        ...
        public float CurrentHealth
        {
            ...
            set
            {
                ...
                // lets clamp the current healths value to be beween the min and max health values.
                ...
                if (healthSlider != null)
                {
                    ...
                    if (fillImage != null)
                    {
                        // let's lerp the colour between the zero health color, the fullhealth color, and lerp it over the normalised value of the current health and maxhealth
        ...
        public void SetUp(Transform TankTransform)
        {
            ...
            // lets call the set up health bar function
            SetupHealthBar();
            // lets call the settomaxhealth function
            SetToMaxHealth();
        }
        public void SetToMaxHealth()
        {
            // lets set the current health to be the max health value
        ...
        protected void SetupHealthBar()
        {
            ...
            {
                // lets create a new instance by calling the instiate function and passing in the health bar prefab and parent it to the tank transform.
        ...
        {
            // lets increase the current health to be increase by the amount coming in.
        ...
        public bool IsDead()
        {
            // return true or false if the health is less than or equal to zero.
